...
var useModal = function (modal, closeOnOverlayClick, test='') {
...
var Logo$2 = function (_a) {
    ...
    return  React.createElement(Text, { color: "#FFFFFF", mx: "4px" }, "PIORNEER Bank");
...
var useWalletModal = function (login, logout, account) {
    var onPresentConnectModal = useModal(React.createElement(ConnectModal, { login: login }),void 0, 'connectmodal')[0];
...
var blueColors = __assign(__assign(__assign({}, baseColors), brandColors), { 
    secondary: "#005cb3", 
    primary: "#0084ff",
    background: "#FAF9FA", 
    backgroundDisabled: "#E9EAEB", 
    backgroundAlt: "#128dff", contrast: "#191326", dropdown: "#005cb3", 
    invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", 
    tertiary: "#005cb3", text: "#EAE2FC", textDisabled: "#BDC2C4", textSubtle: "#ffffff", borderColor: "#E9EAEB", 
    gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
        cardHeader: "linear-gradient(111.68deg, #F2ECF2 0%, #E8F2F6 100%)",
        blue: "linear-gradient(180deg, #A7E8F1 0%, #94E1F2 100%)",
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { 
    secondary: "#9A6AFF", 
    background: "#100C18", 
    backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", 
    contrast: "#FFFFFF", dropdown: "#1E1D20", invertedContrast: "#191326", 
    input: "#483f5a", inputSecondary: "#66578D", primaryDark: "#0098A1", 
    tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#A28BD4", borderColor: "#524B63", gradients: {
...
var blue$7 = {
    background: blueColors.backgroundAlt,
};
var dark$7 = {
...
var blue$6 = {
    ...
    boxShadowWarning: shadows.warning,
    cardHeaderBackground: {
        default: blueColors.gradients.cardHeader,
        blue: blueColors.gradients.blue,
        violet: blueColors.gradients.violet,
    },
    dropShadow: "drop-shadow(0px 1px 4px rgba(25, 19, 38, 0.15))",
};
var dark$6 = {
...
var blue$5 = {
    handleBackground: blueColors.backgroundAlt,
    handleShadow: blueColors.textDisabled,
};
var dark$5 = {
...
var lightTheme = __assign(__assign({}, base), { 
    isDark: false, alert: light$7, 
    colors: lightColors, 
    card: light$6, 
    toggle: light$3, nav: light$2, modal: light$1, pancakeToggle: light$5, radio: light$4, tooltip: light });

var blueTheme = __assign(__assign({}, base), { isDark: false, alert: blue$7, colors: blueColors, card: blue$6, toggle: blue$3, nav: blue$2, modal: blue$1, pancakeToggle: blue$5, radio: blue$4, tooltip: blue });

export { Icon$1u as AddIcon, 
    Alert, 
    Icon$1t as ArrowBackIcon, 
    Icon$1s as ArrowDownIcon, 
    Icon$1r as ArrowDropDownIcon, 
    Icon$1q as ArrowDropUpIcon, 
    Icon$1p as ArrowForwardIcon, 
    Icon$1o as ArrowUpIcon, 
    Icon$1n as AutoRenewIcon,
    BackgroundImage, 
    BalanceInput, 
    GridLayout$1 as BaseLayout, 
    Icon$1m as BinanceIcon, 
    Icon$1w as BlockIcon, 
    Box, 
    Breadcrumbs,
    Icon$1l as BunnyPlaceholderIcon, 
    Button, 
    ButtonMenu$1 as ButtonMenu, 
    ButtonMenuItem, 
    Icon$1i as CalculateIcon, 
    Card, CardBody, CardFooter, CardHeader, CardRibbon, 
    Icon$1j as CardViewIcon, Icon$1k as Cards, 
    GridLayout as CardsLayout, 
    Icon$1g as ChartIcon, 
    Checkbox, Icon$1y as CheckmarkCircleIcon, 
    Icon$1f as CheckmarkIcon, 
    Icon$1e as ChevronDownIcon, 
    Icon$1d as ChevronLeftIcon, 
    Icon$1c as ChevronRightIcon, 
    Icon$1b as ChevronUpIcon, 
    Icon$1h as CircleOutlineIcon, 
    Icon$1a as CloseIcon, 
    Icon$19 as CogIcon, Icon$18 as CommunityIcon, 
    ConnectorNames, Icon$17 as CopyIcon, 
    Icon$16 as CrownIcon, Dropdown, 
    Icon$1x as ErrorIcon, ExpandableButton, 
    ExpandableLabel, FallingBunnies, Flex, Heading,
    Icon$15 as HelpIcon, Icon$14 as HistoryIcon, 
    IconButton, Image, Icon$1v as InfoIcon, 
    Input$1 as Input, Icon$13 as LaurelLeftIcon, Icon$12 as LaurelRightIcon, 
    Link, LinkExternal, Icon$11 as ListViewIcon, Icon$10 as LogoIcon, Icon$$ as LogoRoundIcon, 
    Icon$_ as MedalBronzeIcon, Icon$Z as MedalGoldIcon, Icon$Y as MedalPurpleIcon, 
    Icon$X as MedalSilverIcon, Icon$W as MedalTealIcon, Menu, Icon$V as MetamaskIcon, 
    Icon$U as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, 
    ModalContainer, ModalHeader, ModalProvider, ModalTitle, 
    Icon$T as NoProfileAvatarIcon, NotificationDot, Icon$S as OpenNewIcon, Icon$Q as PancakeRoundIcon, 
    PancakeToggle, Icon$R as PancakesIcon, Icon$O as PlayCircleOutlineIcon, Icon$P as PocketWatchIcon, Icon$N as PrizeIcon, 
    Progress, Icon$K as ProgressBunny, Radio, Icon$s as RefreshIcon, Icon$M as RemoveIcon, 
    ResetCSS, Icon$A as SearchIcon, Skeleton, Slider, Spinner, Step, Stepper, Svg, 
    Icon$z as SwapVertIcon, Icon$y as SyncAltIcon, Tab, ButtonMenu as TabMenu, 
    Tag, Icon$H as TeamPlayerIcon, Icon$G as TestnetIcon, Text, Icon$F as Ticket, Icon$E as TicketRound, 
    Icon$D as TimerIcon, ToastContainer, Toggle, Icon$C as TrophyGoldIcon, Icon$B as TuneIcon, Icon$L as VerifiedIcon, 
    Icon$x as VisibilityOff, Icon$w as VisibilityOn, Icon$v as VolumeOffIcon, Icon$u as VolumeUpIcon, Icon$J as WaitIcon, 
    Icon$t as WarningIcon, Icon$I as Won, variants$2 as alertVariants, byTextAscending, byTextDescending, 
    connectorLocalStorageKey, 
    darkTheme as dark, darkColors,
    blueTheme as blue, blueColors, 
    lightTheme as light, lightColors, makeRender, links as menuConfig, status as menuStatus, types as toastTypes, 
    useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useTooltip, useWalletModal };
